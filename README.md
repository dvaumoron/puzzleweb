...
A library based on [Gin](https://gin-gonic.com/) to easily create a microservice backed server allowing to include static content, blog, wiki and forum with role based right management, user profile and user settings.
